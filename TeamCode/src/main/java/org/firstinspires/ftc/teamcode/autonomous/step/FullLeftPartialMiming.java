...
public class FullLeftPartialMiming extends LinearOpMode {
    ...
    final ProfessionalMime mimeTimeToSkyStone = new ProfessionalMime("mime-auto-competition-final-sceneone-left.txt", driver, hands, new Runnable() {
        @Override
        public void run() {
    ...
    final ProfessionalMime mimeTimeFromSkyStone = new ProfessionalMime("mime-auto-competition-final-scenetwo-left.txt", driver, hands, new Runnable() {
        @Override
        public void run() {
