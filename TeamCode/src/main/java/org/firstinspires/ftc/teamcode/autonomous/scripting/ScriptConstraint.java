...
public class ScriptConstraint {
    ...
    public org.firstinspires.ftc.teamcode.autonomous.scripting.Operation operation;
    public float target;

    public static boolean process(float current, org.firstinspires.ftc.teamcode.autonomous.scripting.Operation operation, float target) {
        switch(operation) {
...
class TimeScriptConstraint extends ScriptConstraint {
    ...
    public boolean test(float time) {
        ...
        return org.firstinspires.ftc.teamcode.autonomous.scripting.ScriptConstraint.process(time - initialTime, this.operation, this.target);
    }

    public TimeScriptConstraint(String arg) {

        this.operator = "TIME";
        this.operation = org.firstinspires.ftc.teamcode.autonomous.scripting.Operation.MORE_EQUAL;
